...
//        查询Token储存的用户
    ...
    public ResponseFormat getClass(@PathVariable Integer groupId){
        List<ClassInfo> classInfos=service.getClassInfo(groupId);
        return ResponseFormat.successful(classInfos);
    }
