    ...
    <div class="cart-box" v-if="isLogin && cartList.length>=0" >
      ...
      <div class="cart-list">
        <div class="cart-item" v-for="item in cartList" :key="item.goods_id">
          <van-checkbox icon-size="18" @click="toggleCheck(item.goods_id)" :value="item.isChecked"></van-checkbox>
...
export default {
  ...
  computed: {
    ...
    ...mapGetters('cart', ['isAllChecked', 'selCartList', 'cartTotal', 'selCount', 'selPrice'])
  },
  data () {
    return {
      checked: false,
