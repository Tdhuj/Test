  ...
  <div class="prodetail">
    ...
    <div class="info">
      <div class="title">
        ...
        <div class="sellcount">已售{{detail.goods_sales_count}}件</div>
      </div>
    ...
    <div class="comment">
      ...
      <div class="comment-list">
        <div class="comment-item" v-for="item in commentList" :key="item.delivery_id
">
          <div class="top">
            <img :src="item.user.avatar_url ? item.user.avatar_url : defaultImg" alt="">
